...
int PKG_ToMid_8583_3(  char * epcOrgMsg, int eiOrgMsgLen,
                       ...
                       UDP opfsAddr )
{
   ...
   UDO_AddField( opfsAddr, 0, UDT_BIN, epcOrgMsg+iMsgPos, 4 );
   iMsgPos += 4;

   UDO_AddField( opfsAddr, 1, UDT_BIN, epcOrgMsg+iMsgPos, 16 );
