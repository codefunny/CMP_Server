...
int PKG_CreateTmsLimitField( MsgFldCfgAry *pstMsgFldCfgAry, int iFldId,
                            UDP epfAddr, char *pczFldContent )
{
   ...
   case PKG_UNFIXLEN_FLD:
      ...
      memcpy( pczFldContent, aczFieldContent, iLen );
#if 0
      {
                      ...
                      MsgFldCfgAry * epstMsgFldCfgAry, UDP  epfsAddr )
{
   ...
   *opiOutMsgLen = 0;
   ...
   for( i = 0; i < iTranFldNums; i++ )
   {
      ...
      iFldLen = PKG_CreateTmsLimitField( epstMsgFldCfgAry, iSeq,
